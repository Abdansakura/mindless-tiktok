...
(function () {
  ...
  form.querySelectorAll(".menit-input").forEach((inp) => {
    inp.addEventListener("input", () => {
      ...
      if (inp.value && parseInt(inp.value) > 0)
        inp.closest(".q-block")?.classList.add("answered");
  ...
  function showAlert() {
    ...
    alertEl.textContent = "⚠️ Masih ada pertanyaan yang belum dijawab!";
    alertEl.style.cssText =
      "position:fixed;bottom:2rem;left:50%;transform:translateX(-50%);background:#fee2e2;color:#b91c1c;border:1.5px solid #fca5a5;padding:0.85rem 1.5rem;border-radius:999px;font-size:0.9rem;font-weight:600;z-index:999;box-shadow:0 4px 20px rgba(0,0,0,0.1);white-space:nowrap;";
